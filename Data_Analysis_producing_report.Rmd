...
ggplot(All_data, aes(x=Channel_1_Cq_PROD, y=Channel_1_Cq_VAL)) + geom_point() +
  xlab('Production DNA target Cq values') + ylab('Validation DNA target Cq values')
...
ggplot(All_data, aes(x=Channel_2_Cq_PROD, y=Channel_2_Cq_VAL)) + geom_point() +
  xlab('Production extraction control Cq values') + ylab('Validation extraction control Cq values')
```
